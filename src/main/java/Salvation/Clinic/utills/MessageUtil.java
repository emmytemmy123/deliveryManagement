package Salvation.Clinic.utills;
...
>>>>>>> origin/master:src/main/java/delivery/management/utills/MessageUtil.java
    ...
    public final static String INVALID_PRICE = "The price is Invalid";
    public final static String INVALID_QUANTITY = "Quantity must not be less than 1";
    public final static String INVALID_NUMBER = "quantity number must not be less than 1";
    public final static String INVALID_STATUS = "No recommendation to be admitted ";
    public final static String INVALID_ADMISSION = " No need for Admission";
    ...
    public final static String  INVALID_DATE_FORMAT = "Date format parameter(s) is/are incorrect";
